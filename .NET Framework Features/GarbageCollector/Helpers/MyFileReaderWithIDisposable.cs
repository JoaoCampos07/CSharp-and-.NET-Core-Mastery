 ...
 *    Porque no caso de ter sido invocad o pelo finalizer nao temos a certeza se nessa altura o obj, ou objs ainda existem sequer ! 
 *    
...
namespace GarbageCollector.Helpers
{
    using System;
    using System.IO;
